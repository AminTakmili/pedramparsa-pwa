...
@Component({
  selector: 'app-textbook-section',
  templateUrl: './textbook-section.component.html',
  styleUrls: ['./textbook-section.component.scss'],
})
export class TextbookSectionComponent implements OnInit {
  id:number|string
  ...
  async getData(){
    ...
    this.global.httpPost('lessons/lessons',
    {
      limit:this.limit,
      offset:this.offset,
      book_id:this.id
