...
@Component({
  selector: 'app-podcastsgroup',
  templateUrl: './podcastsgroup.component.html',
  styleUrls: ['./podcastsgroup.component.scss'],
})
export class PodcastsgroupComponent implements OnInit {
  id:number|string
